  ...
  return (
    <div className="mb-12">
      <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
        <div className={`px-8 py-6 ${colors.header} border-b border-slate-200`}>
          ...
          <table className="min-w-full">
            <thead className={colors.tableHeader}>
              <tr>
                ...
                <th
                  className="px-4 py-4 text-center text-sm font-semibold text-slate-700 uppercase tracking-wider border-r border-slate-200"
                  colSpan={2}
                >
                  พฤษภาคม
                </th>
              ...
              <tr className="bg-rose-25">
                ...
                <th className="px-3 py-3 text-center text-xs font-medium text-slate-500 uppercase tracking-wider border-r border-slate-200">
